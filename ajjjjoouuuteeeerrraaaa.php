...
<div align="right">
  <p>&nbsp;</p>
  <p align="center" class="style18 style24">مــــــــتابـــــــعة مطالـــــــــب الماء الصالح للشراب <span class="style19"></span></p>
  <p>&nbsp;</p>
  <form id="b1" name="b1" method="post" action="">
    <label></label>
    <div align="center">
      <label></label>
      <table width="472" height="336" border="1" bgcolor="#999900">
        <tr>
          <td width="462"><div align="center">
              <p>
                ...
                <strong class="style20">                تاريخ الإيداع</strong>  <br />
                <br />
                <input type="text" name="t3" required="required" />
                <span class="style20"><strong>الإسم</strong></span>
              <span class="style22">.....</span></p>
              <p><br />
                <span class="style22">................</span>
                <input type="text" name="t4" required="required" />
                <span class="style20">اللقب</span><span class="style22">..<span class="style23">.</span></span><span class="style23">....................</span></p>
              <p><br />
                <strong><span class="style23">.</span></strong><span class="style23">......
                <input type="text" name="t5" required="required" />
                </span><span class="style27">.</span><span class="style20"><span class="style22">.</span>العنوان<span class="style22">.</span></span><span class="style22">.......</span></p>
          </div>
          <p align="center">
            <label><span class="style23">....
            </span>
...
include("connection.php");
  ...
  $dossier=$_POST["t5"];
  $renuion=$_POST["t6"];
	$sql=mysql_query("insert into permis2(inscription, date, source, sujet, dossier, renuion) values('$inscription','$date','$source', '$sujet', '$dossier','$renuion')");
	if($sql)
	{
	?>
