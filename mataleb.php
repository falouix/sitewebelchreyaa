...
.style32 {color: #3F3F3F}
.style34 {
	color: #000000;
	font-size: 16px;
}
.style35 {color: #ccccff}
...
<form name="form1" method="post" action="motaba3atdhaw.php">
  <fieldset class="loginField">
  <div align="center">
    <legend class="style5"></legend>
    <legend class="style5"></legend>
    <legend class="style5"></legend>
    <legend class="style5">فـــــــضاء متابـــــــــــعة الــــــــمطالـــــــــب</legend>
    <p class="style10">الماء الصالح للشراب </p>
    <p>&nbsp;</p>
      ...
      <tr>
        <td><div align="center">
            <p> <span class="style23">.....</span>
                ...
                <span class="style6"> رقم بطاقة تعريف وطنية </span> <br />
            </p>
          <p><br />
          <br />
                <br />
                <span class="style22">...</span><br />
                <input name="b122" type="submit" class="style18" value="إرسال" />
