    ...
    <div align="center">
      ...
      <table width="417" height="336" border="1" bgcolor="#999900">
        <tr>
          <td><div align="center">
              <p>
                <input type="text" name="t0" required="required" />
                <span class="style29">رقم بطاقة تعريف</span> </p>
              <p>
                <input type="text" name="t1" required="required" />
                <span class="style20">عدد التسجيل </span><br />
                <br />
                <span class="style23">...</span>
                <input type="date" name="t2" required="required" />
                <span class="style20">تاريخ التسجيل </span><br />
                <br />
                <input type="text" name="t3" required="required" />
                <span class="style26"><strong>المصدر</strong></span>
                <span class="style22">.....</span></p>
              <p><br />
                <span class="style22">................</span>
                <input type="text" name="t4" required="required" />
                <span class="style20">الموضوع و العنوان</span><span class="style22">...</span></p>
              <p><br />
                <strong><span class="style23">.</span></strong><span class="style23">......
                <input type="text" name="t5" required="required" /> 
                .<span class="style22">.</span></span><span class="style27">.....</span><span class="style26">عددالملف</span><span class="style22">..</span></p>
          </div>
          <p align="center">
            <label>
      ...
      <p>
        <label>
        <input type="submit" name="b1" value="تسجل" />
        </label>
      </p>
    </div>
  </form>
...
include("connection.php");
  ...
  $dossier=$_POST["t5"];
  $renuion=$_POST["t6"];
	$sql=mysql_query("insert into permis(numcin, inscription, date, source, sujet, dossier, renuion) values('$numcin','$inscription','$date','$source', '$sujet', '$dossier','$renuion')");
	if($sql)
	{
	?>
