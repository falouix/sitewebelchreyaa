...
<table width="1861" height="118" border="1">
  <tr>
    <td height="108" bgcolor="#0099FF"><div align="center" class="style2">
      <p class="style4 style29">بلدية الشرايع-مشرق الشمس </p>
      </div></td>
  </tr>
</table>
<div align="right">
  ...
  <table width="1004" height="126" border="1" align="center">
    <tr bgcolor="#999900">
      ...
      <td><div align="center"><span class="style26">عدد الملف</span> </div></td>
      <td><div align="center" class="style26">الموضوع مع العنوان </div></td>
      <td><div align="center" class="style26">المصدر</div></td>
      <td><div align="center" class="style26">تاريخ التسجيل </div></td>
      <td><div align="center" class="style26">عدد التسجيل </div></td>
  ...
  $sql=mysql_query("select* from permis where numcin='$ref'");
  ...
  ?> 
	  ...
	  <td><div align="center"><?php echo"$numcin"; ?></div></td>
    </tr>
	 <?php
  }
  ?>
